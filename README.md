...
```sql
`docker run -d --name mycontainer -p 5000:4500 --env ASPNETCORE_ENVIRONMENT=DEVELOPMENT myimage:v2` komutu ile environment tanımlayarak uygulama ayarlarını belirliyebiliriz.
