$(document).ready(function () {
    ...
    /* Ajax POST / Undoing a Category starts from here */
    $(document).on('click',
        '.btn-undo',
        function (event) {
            ...
            let categoryText = tableRow.find('td:eq(1)').text();
           
            Swal.fire({
                title: 'Geri Yüklemek istediğinize emin misiniz?',
                text: `${categoryText} kategorisi geri yüklenecektir!`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Evet, geri yüklemek istiyorum.',
    ...
    /* Ajax POST /Hard  Deleting a Category starts from here */
    $(document).on('click',
        '.btn-delete',
        function (event) {
            event.preventDefault();
            ...
            Swal.fire({
                ...
                text: `${categoryText} kategorisi kalıcı olarak silinecektir!`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
